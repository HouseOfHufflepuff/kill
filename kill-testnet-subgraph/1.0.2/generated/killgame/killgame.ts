...
export class killgame__stackNodesResult {
  value0: Address;
  value1: Address;
  value2: boolean;
...
export class killgame extends ethereum.SmartContract {
  ...
  airdropAmount(): BigInt {
    let result = super.call("airdropAmount", "airdropAmount():(uint256)", []);

    return result[0].toBigInt();
  }

  try_airdropAmount(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "airdropAmount",
  ...
  try_blocksPerMultiplier(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "blocksPerMultiplier",
      "blocksPerMultiplier():(uint256)",
      [],
  ...
  globalCapBps(): BigInt {
    let result = super.call("globalCapBps", "globalCapBps():(uint256)", []);

    return result[0].toBigInt();
  }

  try_globalCapBps(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("globalCapBps", "globalCapBps():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  maxMultiplier(): BigInt {
    let result = super.call("maxMultiplier", "maxMultiplier():(uint256)", []);

    return result[0].toBigInt();
  }

  try_maxMultiplier(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "maxMultiplier",
      "maxMultiplier():(uint256)",
      [],
    );
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  spawnCost(): BigInt {
    let result = super.call("spawnCost", "spawnCost():(uint256)", []);

    return result[0].toBigInt();
  }

  try_spawnCost(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("spawnCost", "spawnCost():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  stackHeads(param0: BigInt): Address {
    let result = super.call("stackHeads", "stackHeads(uint256):(address)", [
  ...
  try_stackHeads(param0: BigInt): ethereum.CallResult<Address> {
    let result = super.tryCall("stackHeads", "stackHeads(uint256):(address)", [
      ethereum.Value.fromUnsignedBigInt(param0),
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  stackNodes(param0: BigInt, param1: Address): killgame__stackNodesResult {
    let result = super.call(
      "stackNodes",
      "stackNodes(uint256,address):(address,address,bool)",
      [
        ethereum.Value.fromUnsignedBigInt(param0),
    ...
    return new killgame__stackNodesResult(
      result[0].toAddress(),
      result[1].toAddress(),
      result[2].toBoolean(),
    );
  ...
  try_stackNodes(
    param0: BigInt,
    param1: Address,
  ): ethereum.CallResult<killgame__stackNodesResult> {
    let result = super.tryCall(
      "stackNodes",
      "stackNodes(uint256,address):(address,address,bool)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new killgame__stackNodesResult(
        value[0].toAddress(),
        value[1].toAddress(),
        value[2].toBoolean(),
      ),
  ...
  totalKillAdded(): BigInt {
    let result = super.call("totalKillAdded", "totalKillAdded():(uint256)", []);

    return result[0].toBigInt();
  }

  try_totalKillAdded(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "totalKillAdded",
      "totalKillAdded():(uint256)",
      [],
    );
    if (result.reverted) {
      return new ethereum.CallResult();
...
export class SetConfigCall__Inputs {
  ...
  get _spawnCost(): BigInt {
    return this._call.inputValues[0].value.toBigInt();
  }

  get _treasuryBps(): BigInt {
    return this._call.inputValues[1].value.toBigInt();
  }

  get _maxMultiplier(): BigInt {
    return this._call.inputValues[2].value.toBigInt();
  }

  get _blocksPerMultiplier(): BigInt {
    return this._call.inputValues[3].value.toBigInt();
  }

  get _globalCapBps(): BigInt {
